...
cover: "https://cdn.jsdelivr.net/gh/huuskonenhenri/blog/public/covers/keep-dependencies-up-to-date.png"
---
...
Here's a quick recap what we have done so far:
    - <Notation type="highlight" color="yellow">Added Dependabot to your repository to automatically create pull requests for version upgrades.</Notation>
    - <Notation type="highlight" color="yellow">Added Playwright tests to your CI pipeline to make sure that the updates don't break your application.</Notation>
    - <Notation type="highlight" color="yellow">Created a GitHub Actions workflow file that listens for new pull requests from Dependabot and automatically approves and merges them.</Notation>
</Notation>
